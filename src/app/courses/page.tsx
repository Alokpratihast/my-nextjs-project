...
import courseData from "@/data/courseunfo.json"
    ...
    <div className="min-h-screen bg-black py-12 pt-36">
        ...
        <div className="flex flex-wrap justify-center">
            {courseData.courses.map((course) => (
                <CardContainer key={course.courseId}className="inter-var m-4">
                ...
                <CardItem translateZ="100" className="w-full mt-4">
                  <div className="h-60 w-full bg-gray-200 rounded-xl"></div> {/* Placeholder for image */}
                </CardItem>
              )}
